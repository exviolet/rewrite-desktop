...
У webview намеренно узкая shell-поверхность: `tmux` и `orca-ide`, заскоупленный
четырьмя подкомандами на чтение/отправку. Ни произвольных процессов, ни сетевых
вызовов из редактора — доступ к файлам в home безопасен именно поэтому.
