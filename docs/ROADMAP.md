...
OpenAI/Google/Anthropic, отзывы в `docs/{gpt5.5,gemini3.1,gemini3.5,opus4.8,search-ai}*.md`):
самый когерентный совет — «перестань добавлять фичи, выпусти v0.2 на укрепление».
...
- **Bulk-replace применяет пары последовательно, не single-pass.**
  ...
  оставлено как known limitation (отмечено в ревью gemini3.5, 2026-06-14).
