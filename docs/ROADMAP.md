...
| 7 | Workspaces (группировка табов по проекту; НЕ knowledge base) | — | **greenlit 2026-07-07** — реформ. как workspace-группировка (боль «пространство»); теги отложены; спек когда active |
