...
| 14 | Кастомизация хоткеев (реестр команд + редактирование в `Ctrl+/`) | [tasks/16-hotkey-customization.md](../tasks/16-hotkey-customization.md) | **active** (2026-08-08) — пять накопленных жильцов. Вторая ценность крупнее первой: раскладка живёт в трёх независимых местах и уже разъехалась, реестр убирает **причину** вранья подписей (за две сессии ловили пять раз) |
